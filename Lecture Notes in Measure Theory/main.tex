...
This is a set of lecture notes which I took for reviewing stuff that I typed after taking class from Professor \textit{insert name here}. All the typos and errors are of mine. The pictures that make here (if any) will be hand drawn and I will appreciate it if someone who is knowledgeable in Tikz will help me digitizing my rough hand-drawn pictures.
\tableofcontents
