...
\title{Lecture Notes in Finite Frames}
...
This is a set of lecture notes which I took for reviewing stuff that I typed after taking class from \textit{Dr P Devaraj}. All the typos and errors are of mine.
\tableofcontents
