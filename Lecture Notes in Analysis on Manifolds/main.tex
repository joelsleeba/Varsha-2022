...
\title{Lecture Notes in Analysis on Manifolds}
\author{Joel Sleeba \\ {\small forked from \href{https://github.com/ashishKujur7/Lecture-Notes}{Ashish Kujur}}}
\date{Last Updated: \today}
\begin{document}

\maketitle
\section*{Introduction}
This is a set of lecture notes which I took for reviewing stuff that I typed after taking class from \textit{Dr. Shrihari Sridharan}. All the typos and errors are of mine. The pictures that make here will be hand drawn and I will appreciate it if someone who is knowledgeable in Tikz will help me digitizing my rough hand-drawn pictures.
\tableofcontents
